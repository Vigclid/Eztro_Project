...
import { AuthNavigationProp, BoardingHouseNavigationProp, RootStackParamList } from "../../navigation/navigation.type";
  ...
  const handleLoginPress = async () => {
    ...
    try {
      ...
      if (loginAsync.fulfilled.match(result)) {
        ...
        // Failure
        setError(typeof result.payload === 'string' ? result.payload : "Email hoặc mật khẩu không đúng");
      }
    } catch (err) {
      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        >
          ...
          >
            ...
            <Text style={styles.subtitle}>Đăng nhập để tiếp tục quản lý nhà trọ</Text>
            ...
            <View style={styles.inputContainer}>
              ...
              {email && (emailError || emailSuccess) && (
                <Text style={emailError ? styles.validationError : styles.validationSuccess}>
            ...
            <View style={styles.inputContainer}>
              ...
              {password && (passwordError || passwordSuccess) && (
                <Text style={passwordError ? styles.validationError : styles.validationSuccess}>
